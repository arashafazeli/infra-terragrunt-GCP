...
variable "istio_disabled" {
  description = "Used to diable Istio. Use istio_disabled to set"
  type        = bool
  default     = true
}

variable "istio_auth" {
  description = "Can be set to AUTH_MUTUAL_TLS"
  type        = string
...
variable "release_channel" {
  description = "The release channel for automatic updates of the cluster"
  type        = string
  default     = "REGULAR"
}
