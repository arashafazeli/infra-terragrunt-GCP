...
inputs = {
  name                  = "Analytics Service - Consumption of Kafka topics 2"
  combiner              = "OR"
  ...
  conditions = [{
    ...
    condition_threshold = {
      filter          = "metric.type=\"logging.googleapis.com/user/bi-pipeline-topic-error-versus\" resource.type=\"k8s_container\""
      duration        = "0s"
