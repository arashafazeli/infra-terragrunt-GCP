...
inputs = {
  ...
  team                                = "games-team"
  product                             = "gnog"
  service_name                        = "claim-streak-service"
  db_user_name                        = "claim-streak-service-user"
  db_instance_type                    = "db-custom-1-4096"
  db_name                             = "claim-streak-service"
  db_insights_enabled                 = true
  db_insights_record_application_tags = true
  db_insights_record_client_address   = true
