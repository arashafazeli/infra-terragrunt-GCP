...
inputs = {
  ...
  db_user_name                    = "team-service-user"
  db_instance_type                = "db-custom-1-4096"
  db_name                         = "team-service"
  db_insights_enabled             = true
  db_insights_query_string_length = 4500
  postgres_version                = "POSTGRES_14"
  db_enable_failover_replica      = true
  gloot_roles                     = ["USER", "FEATURE_VIEW_BLOCKS", "FEATURE_USER_MANAGEMENT", "GLL_SERVER"]
