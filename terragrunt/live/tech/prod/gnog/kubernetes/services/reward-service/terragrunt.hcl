...
inputs = {
  ...
  db_user_name     = "reward-user"
  db_instance_type = "db-custom-4-4096"
  db_name          = "reward-service"
  postgres_version = "POSTGRES_11"
  gloot_roles      = ["USER", "FEATURE_COIN_RESERVATION", "FEATURE_COIN_GIVEAWAY", "xp.user.reward", "player.profile.item.modifier"]
