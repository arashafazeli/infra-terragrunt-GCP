...
inputs = {
  ...
  team         = "games"
  product      = "gnog"
  service_name = "game-config-github-service"
  gloot_roles  = ["FEATURE_GAME_ADMIN", "FEATURE_GAME_CONFIGURATION_EDIT", "FEATURE_GAME_STATUS_EDIT", "FEATURE_STATS_PROPERTIES_EDIT"]
