...
inputs = {
  name                  = "Analytics Service - Data Structure [DEV]"
  combiner              = "OR"
  ...
  conditions = [{
    ...
    condition_threshold = {
      filter          = "metric.type=\"logging.googleapis.com/user/bi-pipeline-dev-unknown-properties\" resource.type=\"k8s_container\""
      duration        = "0s"
    ...
    },
    {
      ...
      condition_threshold = {
        filter          = "metric.type=\"logging.googleapis.com/user/bi-pipeline-dev-currency-conversion-fail\" resource.type=\"k8s_container\""
        duration        = "0s"
        comparison      = "COMPARISON_GT"
        threshold_value = "100"
        trigger = {
