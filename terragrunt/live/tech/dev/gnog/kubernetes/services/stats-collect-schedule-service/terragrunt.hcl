...
inputs = {
  ...
  team                       = "games-team"
  product                    = "gnog"
  service_name               = "stats-collect-schedule-service"
  db_user_name               = "stats-collect-schedule-user"
  db_instance_type           = "db-f1-micro"
  postgres_version           = "POSTGRES_14"
  db_name                    = "stats-collect-schedule-service"
  db_enable_failover_replica = false
  gloot_roles                = ["USER", "user.view-extended"]
