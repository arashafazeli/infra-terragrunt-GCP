...
inputs = {
  ...
  team                       = "backend-team"
  product                    = "gnog"
  service_name               = "mission-service-2"
  db_user_name               = "mission-user"
  db_instance_type           = "db-custom-1-4096"
  postgres_version           = "POSTGRES_14"
  db_name                    = "mission-service-2"
  db_enable_failover_replica = false
  gloot_roles                = ["user", "wallet.subscription.user.view", "wallet.subscription.view", "stats.rules.edit"]
