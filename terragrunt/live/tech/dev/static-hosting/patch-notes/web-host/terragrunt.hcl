...
dependency "project" {
  config_path = "${get_parent_terragrunt_dir()}/tech/dev/static-hosting/patch-notes/_project"
  mock_outputs = {
    project_id = "invalid"
  }
...
dependency "static-dns-zone" {
  config_path = "${get_parent_terragrunt_dir()}/tech/dev/static-hosting/dns/static.dev.gloot.com/dns/dns-zone"
  mock_outputs = {
    name     = "invalid"
    project  = "invalid"
    dns_name = "invalid"
...
inputs = {
  ...
  github_repository_name = "app-patch-notes"
}
